...
public class PausePanel : UIBInder, IAssetLoadable
{
    ...
    private void LoadAsset()
    {
        ...
        AddressableManager.Instance.LoadSprite(_setFalseBgSprite, GetUI<Image>("PausePanelSetFalseBgImage"), () => { _clearLoadAssetCount++; });

        AddressableManager.Instance.LoadSprite(_setFalseSprite, GetUI<Button>("PausePanelSetFalseButton").image, () => { _clearLoadAssetCount++; });
        ...
        AddressableManager.Instance.LoadSprite(_pausePanelNameBgSprite, GetUI<Image>("PausePanelNameBgImage"), () => { _clearLoadAssetCount++; });
    }
